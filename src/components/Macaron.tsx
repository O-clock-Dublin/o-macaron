// pour filer des valeurs à notre fonction composant en paramètre on ajoute des props !

import { useState } from 'react';

// import du custm type (interface) Macaron pour typer la prop macaronToDisplay
